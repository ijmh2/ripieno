...
async function main() {
  const ctx = await esbuild.context({
    ...
    entryPoints: ["src/toolExecutor.ts", "src/browserSession.ts", "src/browserTools.ts", "src/collaborationCommands.ts", "src/extension.ts", "src/permissionServer.ts", "src/workspaceFs.ts", "src/workspaceServer.ts", "src/addressing.ts", "src/soloRelay.ts", "src/invite.ts", "src/relaySecurity.ts", "src/agentHost.ts", "src/runners.ts", "src/runnerEvents.ts", "src/providerEvents.ts", "src/presence.ts", "src/presenceDecorations.ts", "src/presenceLocationPolicy.ts", "src/liveProposalDocuments.ts", "src/workspaceHosting.ts", "src/draftStream.ts", "src/proposalStream.ts", "src/contextDirectives.ts", "src/approvalScope.ts", "src/approvalSummary.ts", "src/roomViewMessages.ts", "src/roomPanelState.ts", "src/teamBoard.ts", "src/agentSetup.ts", "src/agentCommands.ts", "src/goalCommands.ts", "src/goalState.ts", "src/goalMutations.ts", "src/contextMutations.ts", "src/handoffCommands.ts", "src/handoffState.ts", "src/handoffJournal.ts", "src/sessionScope.ts"],
    bundle: true,
    format: "cjs",
    platform: "node",
    target: "node18",
